...
export const TEJ_FIELDS: Record<string, TejField[]> = {
  "F6001": [
    ...
    {
      "code": "F60011004",
      "label": "Investissement recherche et developpement (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011015",
      "label": "Inst. Tech., materiel et outillages Industriels (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011023",
      "label": "Autres creances rattach. a des participat. (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60011024",
      "label": "Creances rattach. a des stes en participat. (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60011025",
      "label": "Vers.a eff./titre de participation non liberes (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60011026",
      "label": "Titres immobilises (droit de propriete) (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011030",
      "label": "Vers.a eff./Titres immobilises non liberes (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011034",
      "label": "Frais d'emission et primes de Remb. Empts (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011038",
      "label": "Stocks Matieres Premieres et Fournit. Liees (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011048",
      "label": "Creances/travaux non encore facturables (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60011049",
      "label": "Clt-pdts non encore factures (pdt a recev.) (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011058",
      "label": "Prov. / deprec. comptes debiteurs divers (Amortissement/Provision)",
      "type": "T_Nombre15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60011064",
      "label": "Liquidites et equivalents de liquidites (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": [
        {
          "code": "F60011065",
    ...
    {
      "code": "F60011065",
      "label": "Banques, etabl. Financiers et assimiles (Amortissement/Provision)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
  ...
  "F6002": [
    ...
    {
      "code": "F60020006",
      "label": "Capitaux propres avant résultat de l'exercice (Net Exercice) F60020002 + F60020003 + F60020004 + F60020005",
      "type": "T_Nombre15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020014",
      "label": "Empts et dettes assorties de condit. particulières (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020052",
      "label": "Autres Postes des Capitaux Propres et Passifs du Bilan (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020059",
      "label": "Capitaux propres avant résultat de l'exercice (Net Exercice - 1) = lf:F60020059 = lf:F60020055 + lf:F60020056 + lf:F60020057 + lf:F60020058",
      "type": "T_Nombre15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020065",
      "label": "Empts auprès d'étab.Fin. (assortis de s�ret�s) (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020067",
      "label": "Empts et dettes assorties de condit. particulières (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020077",
      "label": "Prov.pour charges à répartir/plusieurs exercices (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020089",
      "label": "Fournisseurs d'immobilisations - effets à payer (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020100",
      "label": "Concours Bancaires et Autres Passifs Financiers (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": [
        {
          "code": "F60020101",
    ...
    {
      "code": "F60020101",
      "label": "Emprunts et autres dettes financières courants (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60020104",
      "label": "Banques, établissements financiers et assimilés (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60020105",
      "label": "Autres Postes des Capitaux Propres et Passifs du Bilan (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
  ...
  "F6003": [
    ...
    {
      "code": "F60030005",
      "label": "Rabais, Remises et Ristournes (3R) accordés/ventes de Marchandises (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030013",
      "label": "Rabais, Remises et Ristournes (3R) accordés/ventes de la Production (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030027",
      "label": "Rabais, Remises et Ristournes (3R) obtenus sur achats marchandises (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030032",
      "label": "Rabais, Remises et Ristournes (3R) obtenus/achats Mat.Premières et Fournit. liées (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60030033",
      "label": "Rabais, Remises et Ristournes (3R) obtenus/achats autres approvisionnements (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030044",
      "label": "Ch.PL/Modif.Compt.à imputer au Réslt de l'exerc.ou Activ.abandonnée (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030051",
      "label": "Dot.Prov.d�pr�c.actifs courants (autres que Val.Mobil.de Placem. et équiv. de liquidités) (Net Exercice)",
      "type": "T_Nombre15",
      "formula": null
    },
    {
      "code": "F60030052",
      "label": "Dot.aux amort. et prov./Modif.Compt. à imputer au Réslt de l'exerc. ou Activ. abandonnée (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030054",
      "label": "Achats d��tudes et prestations services (y compris achat de sous-traitance production) (Net Exercice)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030094",
      "label": "Rabais, Remises et Ristournes (3R) accordés/ventes de Marchandises (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030102",
      "label": "Rabais, Remises et Ristournes (3R) accordés/ventes de la Production (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030105",
      "label": "Produits divers ordin.(sans gains/cession immo.) (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030116",
      "label": "Rabais, Remises et Ristournes (3R) obtenus sur achats marchandises (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030119",
      "label": "Achats stockés-Mat.Premières et Fournit. liées (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030121",
      "label": "Rabais, Remises et Ristournes (3R) obtenus/achats Mat.Premières et Fournit. liées (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60030122",
      "label": "Rabais, Remises et Ristournes (3R) obtenus/achats autres approvisionnements (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030130",
      "label": "Rémun.des administrateurs, gérants et associés (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030133",
      "label": "Ch.PL/Modif.Compt.� imputer au Réslt de l'exerc.ou Activ.abandonnée (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60030134",
      "label": "Autres charges de PL et autres charges sociales (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60030135",
      "label": "Dotations aux amortissements et aux provisions (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": [
        {
          "code": "F60030136",
    ...
    {
      "code": "F60030140",
      "label": "Dot.Prov.d�pr�c.actifs courants (autres que Val.Mobil.de Placem. et équiv. de liquidités) (Net Exercice - 1)",
      "type": "T_Nombre15",
      "formula": null
    },
    {
      "code": "F60030141",
      "label": "Dot.aux amort. et prov./Modif.Compt. à imputer au Réslt de l'exerc. ou Activ. abandonnée (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030143",
      "label": "Achats d��tudes et prestations services (y compris achat de sous-traitance production) (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030153",
      "label": "Dot.amort. et provisions - charges financières (Net Exercice - 1)",
      "type": "T_Nombre15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030156",
      "label": "Reprise/prov.(à inscrire dans les pdts financ.) (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030167",
      "label": "Impôts/bénéfices calculés/Résultat/activ./ ord. (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
    ...
    {
      "code": "F60030175",
      "label": "Effet positif/Modif.C.affectant Réslts Reportés (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
      "code": "F60030176",
      "label": "Effet négatif/Modif.C.affectant Réslts Reportés (Net Exercice - 1)",
      "type": "T_NombrePositif15",
      "formula": null
    },
    {
